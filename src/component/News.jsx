...
export default class News extends Component {
  ...
  async componentDidMount() {
    let url = `https://newsapi.org/v2/top-headlines?country=us&apiKey=c2bc751cc45a41efbed5f449fa0a47bb&page=1&pageSize=21`;
  ...
  handlePrevPageClick = async () => {
    let url = `https://newsapi.org/v2/top-headlines?country=us&apiKey=c2bc751cc45a41efbed5f449fa0a47bb&page=${
      this.state.page - 1
    }&pageSize=21`;
    let data = await fetch(url);
    let parsedData = await data.json();
